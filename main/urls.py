...
from .views import check_authentication, create_product, edit_product, delete_product, view_all_product,show_xml, show_json, show_xml_by_id, show_json_by_id, register, login_user, logout_user
